...
export const Footer = () => (
  <Container className={cn(Container, s.container)}>
    ...
    <div className={s.social}>
      <p className={s.socialTitle}>СВЯЗАТЬСЯ С НАМИ</p>
      <p className={s.socialSubtitle}>Контакты и адреса магазинов</p>
      <ul className={s.socialList}>
        <li>
          <svg
            className={s.socialLinkVK}
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
    ...
    <div className={s.contacts}>
      ...
      <a className={s.link} href="tel:+79034902620">
        8 903 490 26 20
      </a>
    </div>
